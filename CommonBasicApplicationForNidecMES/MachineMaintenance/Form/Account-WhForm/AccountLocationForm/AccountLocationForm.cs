...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance
{
    public partial class AccountLocationForm : FormCommonNCVP
    {
        ...
        {
            Form.Account_WhForm.AccountLocationForm.AddAccountLocationForm acclForm = new Form.Account_WhForm.AccountLocationForm.AddAccountLocationForm();
        ...
        private void BindUpdateCavityData()
        {
            ...
            Form.Account_WhForm.AccountLocationForm.AddAccountLocationForm addform = new Form.Account_WhForm.AccountLocationForm.AddAccountLocationForm();
            addform.vo = vo;
            addform.ShowDialog();
