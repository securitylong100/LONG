...
{
    public partial class Main : FormCommonNCVP
    {
        ...
        private void btnEditBatch_Click(object sender, EventArgs e)
        {
            ...
            f3.updateControls(batchNo, modelNo, modelName,
                subAssyNo, subAssyName, batchDate, shift, line, leader, leaderName, input, output, inputTime, outputTime, remark, false, formAdmin);
        ...
        private void btnAddBatch_Click(object sender, EventArgs e)
        {
            ...
            f3.updateControls(batchNo, modelNo, modelName,
                subAssyNo, subAssyName, batchDate, shift, line, leader, leaderName, input, output, inputTime, outputTime, remark, true, formAdmin);
            f3.Show();
        }
