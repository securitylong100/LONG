...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Dao
{
    class AddGA1ModelThurstDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append("insert into t_checkpusha90main(a90_model, a90_line, a90_barcode, a90_thurst_status, a90_shipping ,a90_user_cd, a90_datetime, a90_factory) ");
                                    sql.Append("values(:a90_model,:a90_line, :a90_barcode, :a90_thurst_status,:a90_shipping,:a90_user_cd,now(),:a90_factory)");
            ...
            sqlParameter.AddParameter("a90_datetime", inVo.RegistrationDateTime);
