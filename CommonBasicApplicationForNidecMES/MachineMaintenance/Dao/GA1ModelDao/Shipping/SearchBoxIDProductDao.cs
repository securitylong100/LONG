...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Dao
{
    class SearchBoxIDProductDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append(@"select a90_model as Model, a90_line as Line, a90_thurst_status as Thurst from t_checkpusha90 where a90_barcode = :a90_barcode order by a90_date + a90_time desc limit 1");
