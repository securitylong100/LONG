...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Dao
{
    public class SearchMainProByHourDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            /*sql.Append(@"select (o4.dates + o4.times) datestimes, o4.model_cd,o4.line_cd, o4.process_cd,  ");
            sql.Append("input_data, output_data, (" + sqlApp + "+" + sqlEn2 + "+" + sqlFundou + "+" + sqlEn1 + "+" + sqlIS + "+" + sqlRA + "+" + sqlSW + "+" + sqlRing + "+" + sqlWE + "+" + sqlWi + "+" + sqlCore + ") as sum_ng,");
            sql.Append("hol_gap_holder as holder, " + sqlRA + " as app, " + sqlEn2 + " as en2, " + sqlFundou + " as fundou, " + sqlEn1 + " as en1, ");
            sql.Append(sqlIS + " as insert_case, " + sqlRA + " as ra, " + sqlSW + " as solder_wire, " + sqlRing + " as solder_ring, "+sqlWi+" as wingding,");
            sql.Append(sqlCore + " as core ");
            ...
            sql.Append(" and o4.output04_id = o3.output03_id and o4.output04_id = o2.output02_id and o4.output04_id = o1.output01_id and ");
            sql.Append("o4.output04_id = i1.input01_id and o4.output04_id = i2.input02_id ");
            ...
            sql.Append("and o4.line_cd = :line_cd and o3.line_cd = :line_cd and o2.line_cd = :line_cd and o1.line_cd = :line_cd and i2.line_cd = :line_cd and i1.line_cd = :line_cd ");
            sql.Append("and o4.output04_id = o3.output03_id and o4.output04_id = o2.output02_id and o4.output04_id = o1.output01_id ");
            sql.Append("and o4.output04_id = i1.input01_id and o4.output04_id = i2.input02_id ");
            ...
            sql.Append("or o4.times in(select max(times) from t_productioncontroller_output04 where times between '05:00:00' and '05:05:00' and dates-1 = :dates and line_cd = :line_cd and model_cd = :model_cd)) "); */
            ...
            sql.Append("output_data, hol_gap_holder as holder, " + sqlRA + " as app, " + sqlEn2 + " as en2, " + sqlFundou + " as fundou, " + sqlEn1 + " as en1, ");
