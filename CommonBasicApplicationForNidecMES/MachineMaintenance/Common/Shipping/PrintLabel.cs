...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Common
{
    ...
    {
        public void createBoxidFiles(string dir, string id, string user, DataGridView dgv1, ref DataGridView dgv2, ref TextBox txt)
        {
            //boxId 名のテキストファイルを生成
            ...
            //string cfg;
            //if (config == "1C") cfg = "1C";
            //else if (config == "1D") cfg = "1D";
            //else if (config == "01") cfg = "01";
            //else if (config == "02") cfg = "02";
            //else cfg = "Error";
            //cfg = config;
            txt.Text = "BoxID: " + id + "   User: " + user;
            txt.Width = 80 * 5;
            ...
            Bitmap bmp4 = BitmapCreate.CopyToBpp(bmp1, 8);
            file = dir + id + ".bmp";
